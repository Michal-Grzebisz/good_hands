...
const HomeHelp = () => {
    ...
    return (
        <section className="help">
            ...
            {
                fundation === true && <div className="help__options__fundation">
                    {
                        first === true &&
                        <div className="help__options__content">
                            <div className="help__options__content__info">
                                <div className="help__options__content__info__text">
                    ...
                    <div className="help__options__content__buttons">
                        <Router>
            ...
            {
                organization === true && <div className="help__options_organization">
                    {
                        first === true &&
                        <div className="help__options__content">
                            <div className="help__options__content__info">
            ...
            {
                local === true && <div className="help__options_local">
                    {
                        first === true &&
                        <div className="help__options__content">
                            <div className="help__options__content__info">
